 ...
 ProductPriceModel = require('../models/productPrice'); // Database Model
 
 module.exports = class ProductPriceService {
   /**
    * @description Create an instance of ProductPriceService
    */
   constructor () {
     // Create instance of Data Access layer using our desired model
     this.MongooseServiceInstance = new MongooseService( ProductPriceModel );
   }
  ...
  async create ( documentToCreate ) {
   ...
   async get ( query) {
     try {
         ...
         if(result.length == 0)
           throw {error: 404, message: "ProductPrice not found"};
