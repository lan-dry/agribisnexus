 //services/UserRoleService.j
 const MongooseService = require("./MongooseService"); // Data Access Layer
 UserRoleModel = require('../models/userRole'); // Database Model
 
 module.exports = class UserRoleService {
  
   /**
    * @description Create an instance of UserRoleService
    */
   constructor () {
    // Create instance of Data Access layer using our desired model
    this.MongooseServiceInstance = new MongooseService( UserRoleModel );
  }
  ...
  async create ( documentToCreate ) {
   ...
   async get ( query) {
     try {
         ...
         if(result.length == 0)
           throw {error: 404, message: "UserRole not found"};
