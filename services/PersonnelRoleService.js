 //services/PersonnelRoleService.j
 const MongooseService = require("./MongooseService"); // Data Access Layer
 PersonnelRoleModel = require('../models/personnelRole'); // Database Model
 
 module.exports = class PersonnelRoleService {
  
   /**
    * @description Create an instance of PersonnelRoleService
    */
   constructor () {
    // Create instance of Data Access layer using our desired model
    this.MongooseServiceInstance = new MongooseService( PersonnelRoleModel );
  }
  ...
  async create ( documentToCreate ) {
   ...
   async get ( query) {
     try {
         ...
         if(result.length == 0)
           throw {error: 404, message: "PersonnelRole not found"};
