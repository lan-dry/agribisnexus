 //services/RoleService.j
 const MongooseService = require("./MongooseService"); // Data Access Layer
 RoleModel = require('../models/role'); // Database Model
 
 module.exports = class RoleService {
   /**
    * @description Create an instance of RoleService
    */
   constructor () {
     // Create instance of Data Access layer using our desired model
     this.MongooseServiceInstance = new MongooseService( RoleModel );
   }
   ...
   async create ( documentoCreate ) {
    ...
    async get ( query) {
      try {
          ...
          if(result.length == 0)
            throw {error: 404, message: "Role not found"};
