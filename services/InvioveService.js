 //services/InvoiceService.j
 const MongooseService = require("./MongooseService"); // Data Access Layer
 InvoiceModel = require('../models/invoice'); // Database Model
 
 module.exports = class InvoiceService {
   /**
    * @description Create an instance of InvoiceService
    */
   constructor () {
    // Create instance of Data Access layer using our desired model
    this.MongooseServiceInstance = new MongooseService( InvoiceModel );
  }
