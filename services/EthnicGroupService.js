 //services/EthnicGroupService.j
 const MongooseService = require("./MongooseService"); // Data Access Layer
 EthnicGroupModel = require('../models/ethnicGroup'); // Database Model
 
 module.exports = class EthnicGroupService {
  
   /**
    * @description Create an instance of EthnicGroupService
    */
   constructor () {
    // Create instance of Data Access layer using our desired model
    this.MongooseServiceInstance = new MongooseService( EthnicGroupModel );
  }
  ...
  async create ( documentToCreate ) {
   ...
   async get ( query) {
     try {
         ...
         if(result.length == 0)
           throw {error: 404, message: "EthnicGroup not found"};
