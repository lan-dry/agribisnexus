 //services/ServiceRateService.j
 const MongooseService = require("./MongooseService"); // Data Access Layer
 ServiceRateModel = require('../models/serviceRate'); // Database Model
 
 module.exports = class ServiceRateService {
   /**
    * @description Create an instance of ServiceRateService
    */
   constructor () {
     // Create instance of Data Access layer using our desired model
     this.MongooseServiceInstance = new MongooseService( ServiceRateModel );
   }
   ...
   async create ( documentToCreate ) {
    ...
    async get ( query) {
      try {
          ...
          if(result.length == 0)
            throw {error: 404, message: "ServiceRate not found"};
