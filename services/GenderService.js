 //services/GenderService.j
 const MongooseService = require("./MongooseService"); // Data Access Layer
 GenderModel = require('../models/gender'); // Database Model
 
 module.exports = class GenderService {
  
   /**
    * @description Create an instance of GenderService
    */
   constructor () {
    // Create instance of Data Access layer using our desired model
    this.MongooseServiceInstance = new MongooseService( GenderModel );
  }
  ...
  async create ( documentToCreate ) {
   ...
   async get ( query) {
     try {
         ...
         if(result.length == 0)
           throw {error: 404, message: "Gender not found"};
