//services/transactionTypeService.j
const MongooseService = require("./MongooseService"); // Data Access Layer
TransactionTypeModel = require('../models/transactionType'); // Database Model

module.exports = class transactionTypeService {
  /**
   * @description Create an instance of transactionTypeService
   */
  constructor() {
    // Create instance of Data Access layer using our desired model
    this.MongooseServiceInstance = new MongooseService(transactionTypeModel);
  }
  ...
  */
  async get(query) {
    try {
      ...
      if (result.length == 0)
        throw { error: 404, message: "TransactionType not found" };
  ...
  /**
 * @description Attempt to upadate a document with the provided object
