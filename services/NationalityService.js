 //services/NationalityService.j
 const MongooseService = require("./MongooseService"); // Data Access Layer
 NationalityModel = require('../models/nationality'); // Database Model
 
 module.exports = class NationalityService {
  
   /**
    * @description Create an instance of NationalityService
    */
   constructor () {
    // Create instance of Data Access layer using our desired model
    this.MongooseServiceInstance = new MongooseService( NationalityModel );
  }
  ...
  async create ( documentToCreate ) {
   ...
   async get ( query) {
     try {
         ...
         if(result.length == 0)
           throw {error: 404, message: "Nationality not found"};
