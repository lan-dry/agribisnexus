 ...
 //employees/EmployeeService.j
 const MongooseService = require("./MongooseService"); // Data Access Layer
 EmployeeModel = require('../models/employee'); // Database Model
 
 module.exports = class EmployeeService {
   /**
    * @description Create an instance of EmployeeService
    */
   constructor () {
    // Create instance of Data Access layer using our desired model
    this.MongooseServiceInstance = new MongooseService( EmployeeModel );
  }
