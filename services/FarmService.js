 //services/FarmService.j
 const MongooseService = require("./MongooseService"); // Data Access Layer
 FarmModel = require('../models/farm'); // Database Model
 
 module.exports = class FarmService {
  
   /**
    * @description Create an instance of FarmService
    */
   constructor () {
    // Create instance of Data Access layer using our desired model
    this.MongooseServiceInstance = new MongooseService( FarmModel );
  }
  ...
  async create ( documentToCreate ) {
   ...
   async get ( query) {
     try {
         ...
         if(result.length == 0)
           throw {error: 404, message: "Farm not found"};
