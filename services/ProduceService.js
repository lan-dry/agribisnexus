 //services/ProduceService.j
 const MongooseService = require("./MongooseService"); // Data Access Layer
 ProduceModel = require('../models/produce'); // Database Model
 
 module.exports = class ProduceService {
   /**
    * @description Create an instance of ProduceService
    */
   constructor () {
     // Create instance of Data Access layer using our desired model
     this.MongooseServiceInstance = new MongooseService( ProduceModel );
   }
   ...
   async create ( documentToCreate ) {
    ...
    async get ( query) {
      try {
          ...
          if(result.length == 0)
            throw {error: 404, message: "Produce not found"};
