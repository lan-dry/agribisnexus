 //services/AuthenticationService.j
 const MongooseService = require("./MongooseService"); // Data Access Layer
 AuthenticationModel = require('../models/authentication'); // Database Model
 
 module.exports = class AuthenticationService {
   /**
    * @description Create an instance of AuthenticationService
    */
   constructor () {
     // Create instance of Data Access layer using our desired model
     this.MongooseServiceInstance = new MongooseService( AuthenticationModel );
   }
  ...
  async create ( documentToCreate ) {
   ...
   async get ( query) {
     try {
         ...
         if(result.length == 0)
           throw {error: 404, message: "Aunthetication not found"};
