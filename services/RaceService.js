 //services/RaceService.j
 const MongooseService = require("./MongooseService"); // Data Access Layer
 RaceModel = require('../models/race'); // Database Model
 
 module.exports = class RaceService {
  
   /**
    * @description Create an instance of RaceService
    */
   constructor () {
    // Create instance of Data Access layer using our desired model
    this.MongooseServiceInstance = new MongooseService( RaceModel );
  }
  ...
  async create ( documentToCreate ) {
   ...
   async get ( query) {
     try {
         ...
         if(result.length == 0)
           throw {error: 404, message: "Race not found"};
