 //services/TitleService.j
 const MongooseService = require("./MongooseService"); // Data Access Layer
 TitleModel = require('../models/title'); // Database Model
 
 module.exports = class TitleService {
  
   /**
    * @description Create an instance of TitleService
    */
   constructor () {
    // Create instance of Data Access layer using our desired model
    this.MongooseServiceInstance = new MongooseService( TitleModel );
  }
  ...
  async create ( documentToCreate ) {
   ...
   async get ( query) {
     try {
         ...
         if(result.length == 0)
           throw {error: 404, message: "Title not found"};
