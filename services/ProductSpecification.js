 //service/ProcuctService.j
 const MongooseService = require("./MongooseService"); // Data Access Layer
 ProductSpecificationModel = require('../models/productSpecification'); // Database Model
 
 module.exports = class ProductSpecificationService {
   /**
    * @description Create an instance of ProductSpecificationService
    */
   constructor () {
     // Create instance of Data Access layer using our desired model
     this.MongooseServiceInstance = new MongooseService( ProductSpecificationModel );
   }
  ...
  async create ( documentToCreate ) {
   ...
   async get ( query) {
     try {
         ...
         if(result.length == 0)
           throw {error: 404, message: "ProductSpecification not found"};
