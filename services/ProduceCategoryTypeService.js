 //services/ProduceCategoryTypeService.j
 const MongooseService = require("./MongooseService"); // Data Access Layer
 ProduceCategoryTypeModel = require('../models/produceCategoryType'); // Database Model
 
 module.exports = class ProduceCategoryTypeService {
  ...
  async create ( documentToCreate ) {
   ...
   async get ( query) {
     try {
         ...
         if(result.length == 0)
           throw {error: 404, message: "ProduceCategoryType not found"};
