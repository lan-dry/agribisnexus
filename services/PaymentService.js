 //services/PaymentService.j
 const MongooseService = require("./MongooseService"); // Data Access Layer
 PaymentModel = require('../models/payment'); // Database Model
 
 module.exports = class PaymentService {
  /**
    * @description Create an instance of PaymentService
    */
   constructor () {
    // Create instance of Data Access layer using our desired model
    this.MongooseServiceInstance = new MongooseService( PaymentModel );
  }
